...
def cell_to_block(
    ...
    return {
        ...
        "source_cell": cell,
        "source_id": cell.get("__source_id"),
        "source_index": cell.get("__source_index"),
        "recognition_order": cell.get("__paddle_order"),
        "reading_order": cell.get("__reading_order", order),
        "source_bbox": list(bbox),
        "source_bbox_units": bbox_units,
